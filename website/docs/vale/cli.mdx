...
- `prose -> YAML`: These styles take _written_ guidelines (such as those
  ...
  and convert them into a collection of Vale-compatible YAML files. The
...
- `code -> YAML`: These styles take guidelines enforced by a
  ...
  into a collection of Vale-compatible YAML files. The benefits of this
...
Print the given file's [metrics](https://docs.errata.ai/vale/styles#metric).
