...
module.exports = {
    ...
    themeConfig: {
        ...
        announcementBar: {
            ...
            isCloseable: false,
            content: 'Enjoying our open-source software? Please consider <a target="_blank" rel="noopener noreferrer" href="https://opencollective.com/vale">becoming a sponsor</a> to support continued development. ❤️'
        },
        algolia: {
        ...
        navbar: {
            ...
            items: [{
                    href: 'https://medium.com/valelint',
                    label: 'Blog',
                    position: 'left'
                }, {
